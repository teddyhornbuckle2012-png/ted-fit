...
function HomeIcon({ active }: { active: boolean }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={active ? '#E8873A' : 'none'}
      stroke={active ? '#E8873A' : '#6B7280'}
      strokeWidth="2"
      className="w-6 h-6"
    >
      <path
...
function DumbbellIcon({ active }: { active: boolean }) {
  return (
    <svg
      ...
      className="w-6 h-6"
    >
      <rect x="2" y="10" width="4" height="4" rx="1" fill={active ? '#E8873A' : 'none'} />
      <rect x="18" y="10" width="4" height="4" rx="1" fill={active ? '#E8873A' : 'none'} />
      <rect x="5" y="8" width="3" height="8" rx="1" fill={active ? '#E8873A' : 'none'} />
      <rect x="16" y="8" width="3" height="8" rx="1" fill={active ? '#E8873A' : 'none'} />
